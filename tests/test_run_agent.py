...
class TestLlamaCppRuntime:
    ...
    def test_build_api_kwargs_passes_llama_cpp_parallel_flag(self, agent):
    ...
    def test_llama_cpp_tool_turn_uses_non_streaming_parser_fallback_and_generated_ids(self, agent):
        self._setup_agent(agent)
        agent.provider = "llama-cpp"
